...
#Fitting logistic Regression to the training set(Logistic is a linear model 2D)

from sklearn.linear_model import LogisticRegression
classifier = LogisticRegression(random_state=0) #random_state = 0 to get the same result
