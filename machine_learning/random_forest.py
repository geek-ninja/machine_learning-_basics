...
plt.title('Truth or Bluf (random_forest)')
plt.xlabel('Position')
plt.ylabel('Salary')
plt.show()

#This mode is very power full in 2D and 3D or more ... not good in 1D.
#In this model more than one decision tree is used to predict  the value and average of all trees are taken to predict the final answer.